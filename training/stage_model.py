...
from flower_classifier.lit_models import BaseLitModel
...
LITMODEL_CLASS = BaseLitModel

api = wandb.Api()

DEFAULT_ENTITY = api.default_entity
DEFAULT_FROM_PROJECT = "flower_classification"
DEFAULT_TO_PROJECT = "flower_classification"
DEFAULT_STAGED_MODEL_NAME = "flower_classifier"

PROD_STAGING_ROOT = PROJECT_ROOT / "flower_classifier" / "artifacts"
